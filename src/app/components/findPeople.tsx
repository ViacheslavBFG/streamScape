...
const FindPeople = () => {
  return (
    <div className="mb-28">
      <p className="flex items-center justify-center text-4xl font-bold mb-10 text-shadow-lg">
        Here you can find
      </p>
      <div className="flex flex-col items-center gap-5 text-xs ">
        <div className="flex items-center gap-3  p-7  w-1/3 rounded-3xl shadow-2xl justify-center  ">
